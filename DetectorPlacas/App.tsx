...
export default function CameraScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.label}>Dirección IP del servidor AWS:</Text>
      <TextInput
        style={styles.input}
        placeholder="Ej: 54.123.456.78"
        value={ip}
        onChangeText={setIp}
      />
      ...
      <Button title="📸 Tomar foto y detectar" onPress={handleCapture} color="#007AFF" />
      ...
      {processedImage && (
        <View style={styles.imageContainer}>
          <Text style={styles.label}>🖼️ Imagen procesada:</Text>
